...
const prompt = `Revise the following customer service message to improve grammar, spelling, clarity in a professional tone, and make the message flow smoothly. Make necessary breaks in paragraphs but no other additional formatting:\n\n${userText}`;
  try {
