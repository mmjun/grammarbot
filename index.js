...
const prompt = `Revise the following customer service message to improve grammar, spelling, and clarity in a professional tone. Do not add additional formatting. Only revise the original message:\n\n${userText}`;
  try {
